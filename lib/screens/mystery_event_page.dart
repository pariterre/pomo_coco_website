              ...
              child: const Text.rich(
                  ...
                  TextSpan(children: [
                    ...
                    TextSpan(
                        ...
                        style: TextStyle(fontStyle: FontStyle.italic)),
                    TextSpan(
                        text: ', la troupe se lança dans une quête périlleuse. '
                    ...
                    TextSpan(
                        ...
                        style: TextStyle(fontStyle: FontStyle.italic)),
                    TextSpan(
                        text: '. Celle-ci semblait également être accompagnée '
                    ...
                    TextSpan(
                        text: 'Balmoral',
                        style: TextStyle(fontStyle: FontStyle.italic)),
                    TextSpan(text: ', la ville voisine. C\'est au château de '),
                    TextSpan(
                        text: 'Balmoral',
                        style: TextStyle(fontStyle: FontStyle.italic)),
                    ...
                    TextSpan(
                        ...
                        style: TextStyle(fontStyle: FontStyle.italic)),
                    TextSpan(
                        text: ' qui tentait de réveiller la nature lycanthrope '
                            'de la rebelle. Soupçonneuse que le groupe avait tourné le dos au '),
                    TextSpan(
                        text: 'Seigneur Garnan',
                        style: TextStyle(fontStyle: FontStyle.italic)),
                    TextSpan(
                        text: ', elle leur donna une occasion de racheter leur '
